...
banner:
  img:
    src: "/src/assets/banner/yc-cooking.gif"
    alt: "YepCode cooking gif"
  title: "We're cooking up new ways to supercharge YepCode for **building AI solutions** ✨"
  buttons:
    - label: "Secure AI code execution"
...
howItWorks:
  ...
  tabs:
    - label: "Process definition"
      description: "Create process definitions writing the source code and using the your env vars and any NPM or Pypi package."
      icon: "code"
      href: "/src/assets/home/how-it-works/process-definition.png"
    - label: "Execution input parameters"
      description: "Each process execution can use input params provided on execution start."
      icon: "cog"
      href: "/src/assets/home/how-it-works/execution-input-params.svg"
    - label: "Execution detail"
      description: "See the log details and timing stats just from the same console."
      icon: "form"
      href: "/src/assets/home/how-it-works/execution-detail.svg"
    - label: "Execution configuration"
      description: "Executions can be started on demand, in a cron scheduled approach, or using webhooks with payload as input params."
      icon: "calendar"
      href: "/src/assets/home/how-it-works/execution-configuration.svg"
    - label: "Audit every change"
      description: "Keep track of how your team is using the platform updating code, managing credentials or using the webhooks"
      icon: "identification"
      href: "/src/assets/home/how-it-works/audit-every-change.svg"
sayYep:
